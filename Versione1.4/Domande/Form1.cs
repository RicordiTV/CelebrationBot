    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < numerodomande ; i++)
            {
                ...
                number = generator.Next(1, numerodomande+1);
                ...
                if (number >= 41 && number <= 80)
                {
                        ...
                        number = number - 40;
                    comboBox1.Text = Fusione2.Text;
                    button8.PerformClick();

                }
                if (number >= 81 && number <= 120)
                {
                        ...
                        number = number - 80;
                    comboBox1.Text = Fusione3.Text;
                    button8.PerformClick();

                }
                if (number >= 121 && number <= 160)
                {
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            string cartellaHost = @""; // Sostituisci con il percorso della tua cartella host
                    ...
                    while (true)
                    {
                        ...
                        ThreadPool.QueueUserWorkItem((state) =>
                        {
                            try
                            {
                                ...
                                string percorsoRichiesto = request.Url.LocalPath.TrimStart('/');
                                string percorsoCompleto = Path.Combine(cartellaHost, percorsoRichiesto);

                                if (File.Exists(percorsoCompleto))
                                {
                                    byte[] buffer = File.ReadAllBytes(percorsoCompleto);

                                    response1.ContentLength64 = buffer.Length;

                                    using (Stream output = response1.OutputStream)
                                    {
                                ...
                                {
                                    response1.StatusCode = (int)HttpStatusCode.NotFound;
                                }
                            }
                            catch (Exception ex)
                            {
                                Console.WriteLine("Errore durante la gestione della richiesta: " + ex.Message);
                            }
                            finally
                            {
            ...
            Console.ReadLine(); // Aggiungi questa linea se vuoi che il programma rimanga in esecuzione
        ...
        string percorsoCartella = "profili/Profilo1";
            ...
            aggiornamento = "NO";
            if (double.TryParse(content, out double value) && value > 13)
            {
                aggiornamento = "SI";
        ...
        private void timer4_Tick_1(object sender, EventArgs e)
        {
            ...
            // Genera un hash MD5 dell'immagine
            using (var md5 = System.Security.Cryptography.MD5.Create())
            {
                // Converte l'immagine in un array di byte
                byte[] hashBytes = md5.ComputeHash(BitmapToByteArray(bitmap));

                // Converte l'array di byte in una stringa esadecimale
                string currentHash = BitConverter.ToString(hashBytes).Replace("-", "").ToLower();

                // Verifica se l'immagine è già stata salvata
                if (File.Exists("image2.png"))
                {
                    // Legge l'hash MD5 dell'immagine precedentemente salvata
                    byte[] savedHashBytes = md5.ComputeHash(File.ReadAllBytes("image2.png"));
                    string savedHash = BitConverter.ToString(savedHashBytes).Replace("-", "").ToLower();

                    // Se gli hash sono uguali, l'immagine è la stessa, non salvare nuovamente
                ...
                try
                {
                    ...
                    bitmap.Save("image2.png", System.Drawing.Imaging.ImageFormat.Png);
        ...
        {
            DialogResult result = MessageBox.Show("Vuoi avviare la versione web?", "Alert", MessageBoxButtons.YesNo);
        ...
        private void button10_Click_3(object sender, EventArgs e)
        {
            ...
            openFileDialog.Filter = "File audio (*.wav)|*.wav";
        ...
        {
            string audioFilePath = textBox22.Text;
            ...
            if (!string.IsNullOrWhiteSpace(audioFilePath))
            {
                ...
                try
                {
                    // Riproduzione continua dell'audio
                    player.PlayLooping();

                    // L'audio sta venendo riprodotto in loop
                    Console.WriteLine("Riproduzione audio in loop.");
                }
                catch (Exception ex)
                {
                    // Si è verificato un errore durante la riproduzione dell'audio
            ...
            {
                // Nessun percorso audio valido nella casella di testo
                Console.WriteLine("Nessun percorso audio valido nella casella di testo.");
            }
        }
        ...
        private async void MetodoPerLeggereChatAsync()
        {
            while (true)
            {
                ...
                // Aggiorna le variabili ogni secondo
                await Task.Delay(1000);
            }
        }
        ...
        private void timer5_Tick_2(object sender, EventArgs e)
        {
            ...
            if (xa.Contains(textBox1.Text))
            {
               
                xa = xa.Replace(textBox1.Text, "").Trim();
        ...
        private void timer5_Tick_3(object sender, EventArgs e)
        {
            timer4.Stop();
        }

        private void timer5_Tick_4(object sender, EventArgs e)
        {
        ...
        private void timer6_Tick(object sender, EventArgs e)
        {
            ...
            if (xa.Contains("!domanda"))
            {
                ...
                else
                {
                    if (Domanda2.Text == "Domanda numero 2")
                    {
                        Domanda2.Text = MyUser + ":" + xa;
                    }
                    else
                    {
                        if (Domanda3.Text == "Domanda numero 3")
                        {
                            Domanda3.Text = MyUser + ":" + xa;
                        }
                        else
                        {
                            if (Domanda4.Text == "Domanda numero 4")
                            {
                                Domanda4.Text = MyUser + ":" + xa;
                            }
                            else
                            {
                                if (Domanda5.Text == "Domanda numero 5")
                                {
                                    Domanda5.Text = MyUser + ":" + xa;
                                }
                                else
                                {
                                    if (Domanda6.Text == "Domanda numero 6")
                                    {
                                        Domanda6.Text = MyUser + ":" + xa;
                                    }
                                    else
                                    {
                                        if (Domanda7.Text == "Domanda numero 7")
                                        {
                                            Domanda7.Text = MyUser + ":" + xa;
                                        }
                                        else
                                        {
                                            if (Domanda8.Text == "Domanda numero 8")
                                            {
                                                Domanda8.Text = MyUser + ":" + xa;
                                            }
                                            else
                                            {
                                                if (Domanda9.Text == "Domanda numero 9")
                                                {
                                                    Domanda9.Text = MyUser + ":" + xa;
                                                }
                                                else
                                                {
                                                    if (Domanda10.Text == "Domanda numero 10")
                                                    {
                                                        Domanda10.Text = MyUser + ":" + xa;
                                                    }
                                                    else
                                                    {
                                                        if (Domanda11.Text == "Domanda numero 11")
                                                        {
                                                            Domanda11.Text = MyUser + ":" + xa;
                                                        }
                                                        else
                                                        {
                                                            if (Domanda12.Text == "Domanda numero 12")
                                                            {
                                                                Domanda12.Text = MyUser + ":" + xa;
                                                            }
                                                            else
                                                            {
                                                                if (Domanda13.Text == "Domanda numero 13")
                                                                {
                                                                    Domanda13.Text = MyUser + ":" + xa;
                                                                }
                                                                else
                                                                {
                                                                    if (Domanda14.Text == "Domanda numero 14")
                                                                    {
                                                                        Domanda14.Text = MyUser + ":" + xa;
                                                                    }
                                                                    else
                                                                    {
                                                                        if (Domanda15.Text == "Domanda numero 15")
                                                                        {
                                                                            Domanda15.Text = MyUser + ":" + xa;
                                                                        }
                                                                        else
                                                                        {
                                                                            if (Domanda16.Text == "Domanda numero 16")
                                                                            {
                                                                                Domanda16.Text = MyUser + ":" + xa;
                                                                            }
                                                                            else
                                                                            {
                                                                                if (Domanda17.Text == "Domanda numero 17")
                                                                                {
                                                                                    Domanda17.Text = MyUser + ":" + xa;
                                                                                }
                                                                                else
                                                                                {
                                                                                    if (Domanda18.Text == "Domanda numero 18")
                                                                                    {
                                                                                        Domanda18.Text = MyUser + ":" + xa;
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        if (Domanda19.Text == "Domanda numero 19")
                                                                                        {
                                                                                            Domanda19.Text = MyUser + ":" + xa;
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            if (Domanda20.Text == "Domanda numero 20")
                                                                                            {
                                                                                                Domanda20.Text = MyUser + ":" + xa;
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                if (Domanda21.Text == "Domanda numero 21")
                                                                                                {
                                                                                                    Domanda21.Text = MyUser + ":" + xa;
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    if (Domanda22.Text == "Domanda numero 22")
                                                                                                    {
                                                                                                        Domanda22.Text = MyUser + ":" + xa;
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                                                        if (Domanda23.Text == "Domanda numero 23")
                                                                                                        {
                                                                                                            Domanda23.Text = MyUser + ":" + xa;
                                                                                                        }
                                                                                                        else
                                                                                                        {
                                                                                                            if (Domanda24.Text == "Domanda numero 24")
                                                                                                            {
                                                                                                                Domanda24.Text = MyUser + ":" + xa;
                                                                                                            }
                                                                                                            else
                                                                                                            {
                                                                                                                if (Domanda25.Text == "Domanda numero 25")
                                                                                                                {
                                                                                                                    Domanda25.Text = MyUser + ":" + xa;
                                                                                                                }
                                                                                                                else
                                                                                                                {
                                                                                                                    if (Domanda26.Text == "Domanda numero 26")
                                                                                                                    {
                                                                                                                        Domanda26.Text = MyUser + ":" + xa;
                                                                                                                    }
                                                                                                                    else
                                                                                                                    {
                                                                                                                        if (Domanda27.Text == "Domanda numero 27")
                                                                                                                        {
                                                                                                                            Domanda27.Text = MyUser + ":" + xa;
                                                                                                                        }
                                                                                                                        else
                                                                                                                        {
                                                                                                                            if (Domanda28.Text == "Domanda numero 28")
                                                                                                                            {
                                                                                                                                Domanda28.Text = MyUser + ":" + xa;
                                                                                                                            }
                                                                                                                            else
                                                                                                                            {
                                                                                                                                if (Domanda29.Text == "Domanda numero 29")
                                                                                                                                {
                                                                                                                                    Domanda29.Text = MyUser + ":" + xa;
                                                                                                                                }
                                                                                                                                else
                                                                                                                                {
                                                                                                                                    if (Domanda30.Text == "Domanda numero 30")
                                                                                                                                    {
                                                                                                                                        Domanda30.Text = MyUser + ":" + xa;
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                                        if (Domanda31.Text == "Domanda numero 31")
                                                                                                                                        {
                                                                                                                                            Domanda31.Text = MyUser + ":" + xa;
                                                                                                                                        }
                                                                                                                                        else
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            if (Domanda32.Text == "Domanda numero 32")
                                                                                                                                            {
                                                                                                                                                Domanda32.Text = MyUser + ":" + xa;
                                                                                                                                            }
                                                                                                                                            else
                                                                                                                                            {
                                                                                                                                                if (Domanda33.Text == "Domanda numero 33")
                                                                                                                                                {
                                                                                                                                                    Domanda33.Text = MyUser + ":" + xa;
                                                                                                                                                }
                                                                                                                                                else
                                                                                                                                                {
                                                                                                                                                    if (Domanda34.Text == "Domanda numero 34")
                                                                                                                                                    {
                                                                                                                                                        Domanda34.Text = MyUser + ":" + xa;
                                                                                                                                                    }
                                                                                                                                                    else
                                                                                                                                                    {
                                                                                                                                                        if (Domanda35.Text == "Domanda numero 35")
                                                                                                                                                        {
                                                                                                                                                            Domanda35.Text = MyUser + ":" + xa;
                                                                                                                                                        }
                                                                                                                                                        else
                                                                                                                                                        {
                                                                                                                                                            if (Domanda36.Text == "Domanda numero 36")
                                                                                                                                                            {
                                                                                                                                                                Domanda36.Text = MyUser + ":" + xa;
                                                                                                                                                            }
                                                                                                                                                            else
                                                                                                                                                            {
                                                                                                                                                                ...
                                                                                                                                                                if (Domanda37.Text == "Domanda numero 37")
                                                                                                                                                                {
                                                                                                                                                                    Domanda37.Text = MyUser + ":" + xa;
                                                                                                                                                                }
                                                                                                                                                                else
                                                                                                                                                                {
                                                                                                                                                                    if (Domanda38.Text == "Domanda numero 38")
                                                                                                                                                                    {
                                                                                                                                                                        Domanda38.Text = MyUser + ":" + xa;
                                                                                                                                                                    }
                                                                                                                                                                    else
                                                                                                                                                                    {
                                                                                                                                                                        ...
                                                                                                                                                                        if (Domanda39.Text == "Domanda numero 39")
                                                                                                                                                                        {
                                                                                                                                                                            Domanda39.Text = MyUser + ":" + xa;
                                                                                                                                                                        }
                                                                                                                                                                        else
                                                                                                                                                                        {
                                                                                                                                                                            if (Domanda40.Text == "Domanda numero 40")
                                                                                                                                                                            {
                                                                                                                                                                                Domanda40.Text = MyUser + ":" + xa;
                                                                                                                                                                            }
                                                                                                                                                                            else
                                                                                                                                                                            { 
                                                                                                                                                                                Domanda41.Text = Domanda41.Text + MyUser + ":" + xa + " ";
                                                                                                                                                                            }
                                                                                                                                                                        }
                                                                                                                                                                    }
                                                                                                                                                                }
        ...
        private void trackBar4_Scroll_1(object sender, EventArgs e)
        {
            ...
            if(trackBar4.Value==1)
            {
                Fusione1.Visible = true;
                Fusione2.Visible = false;
                Fusione3.Visible = false;
                Fusione4.Visible = false;
        ...
        private void Fusione1_TextChanged(object sender, EventArgs e)
        {

        }

        private void Domanda41_TextChanged(object sender, EventArgs e)
        {

        }

        private void timer5_Tick_5(object sender, EventArgs e)
        {
            
        }
       
        private void lowcpu_Tick(object sender, EventArgs e)
        {
        ...
        private void trackBar5_Scroll(object sender, EventArgs e)
        {
            ...
            timer4.Interval = trackBar5.Value;
            label54.Text = "Regola uso cpu fonte Browser: " + trackBar5.Value;
